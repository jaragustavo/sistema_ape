                ...
                <div class="row mb--40">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <span class="subtitle bg-secondary-opacity">Misión y Visión</span>
                            <h2 class="title">APE</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5">
                        ...
                        <div class="tab-content advance-tab-content-style-2">
                            <div class="tab-pane fade active show" id="home-4" role="tabpanel" aria-labelledby="home-tab-4">
                                <div class="content">
                                    <ul style="text-align: left;">
                                        <li>
                                            Asociación líder en Enfermería que vela y defiende los derechos laborales y
                                            ambientales de la Enfermería Paraguaya.
                                        </li>
                                        <li>
                                            En unidad de acción con otras organizaciones gremiales del país para el
                                            desarrollo de servicios públicos de calidad.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="profile-4" role="tabpanel"
                                ...
                                <div class="content">
                                    <ul style="text-align: left;">
                                        <li>
                                            Asociación, líder en Enfermería con excelencia profesional y académica que
                                            se desarrolla en ambientes y condiciones laborales saludables.
                                        </li>
                                        <li>
                                            Comprometida con la comunidad, Integrada en la unidad gremial y reconocida a
                                            nivel Nacional e Internacional. Con valores de solidaridad, honestidad,
