            ...
            <div class="rbt-dashboard-table table-responsive mobile-table-750 mt--30">
                <table class="rbt-table table table-borderless">
                    ...
                    <tbody>
                        ...
                        $key = "mi_key_secret";
                        $cipher = "aes-256-cbc";
                        $_GET["IDCURSO"] = str_replace(' ', '+', $_GET["IDCURSO"]);
                        $iv = openssl_random_pseudo_bytes(openssl_cipher_iv_length($cipher));
                        $iv_dec = substr(base64_decode($_GET['IDCURSO']), 0, openssl_cipher_iv_length($cipher));
                        $cifradoSinIV = substr(base64_decode($_GET['IDCURSO']), openssl_cipher_iv_length($cipher));
                        $_GET['IDCURSO'] = openssl_decrypt($cifradoSinIV, $cipher, $key, OPENSSL_RAW_DATA, $iv_dec);
                        $entregas = Certificacion::get_calificaciones_curso($_GET['IDCURSO']);
                        foreach ($entregas as $entrega) {
                            ...
                            <tr>
                                <th>
                                    ...
                                    <p class="b3"><a href="#"><?php echo $entrega['nombre_curso']; ?></a></p>
                                </th>
                                <td>
