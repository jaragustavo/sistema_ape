...
$('.verifyButton').on('click', function(event) {
    button = $(this); // Asignar el botón actual a la variable button
    ...
    setTimeout(function() {
        cargarIdDoc(tipoDocumentoId);
    }, 1000); // Simulating a 2-second verification process
});
...
function cargarIdDoc(tipoDocumentoId) {
                        ...
                        if (mensaje) {
                            ...
                            fetch(`../${data.foto_ci}`)
                                ...
                                .then(blob => {
                                    ...
                                    // Indicar que se cargó correctamente el archivo
                                    archivoCarga = true;
                                ...
                                .catch(error => {
                                    ...
                                    // Aquí podrías manejar la situación de error, si es necesario
                                });
                        } else {
