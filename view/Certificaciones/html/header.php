                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="tg-header__top-info list-wrap">
                            <li><img src="../../public/skillgro/img/icons/map_marker.svg" alt="Icon"> <span>Estados Unidos N° 1063 casi República de Colombia</span></li>
                            <li><img src="../../public/skillgro/img/icons/envelope.svg" alt="Icon"> <a href="mailto:ae_paraguay@yahoo.com.ar">ae_paraguay@yahoo.com.ar</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <div class="tg-header__top-right">
                            <div class="tg-header__phone">
                                <img src="../../public/skillgro/img/icons/phone.svg" alt="Icon">Llámanos: <a href="tel: 021 224 940 / 0983 859952"> 021 224 940 / 0983 859952</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="tgmenu__wrap">
                            <nav class="tgmenu__nav">
                                <div class="logo">
                                    <a href="../home"><img src="../../public/img/logo_ape.jpg" alt="Logo" style="height:40px; width:40px;"></a>
                                </div>
                                <div class="tgmenu__navbar-wrap tgmenu__main-menu d-none d-xl-flex">
                                    <ul class="navigation">
                                        
                                        <li class="active menu-item-has-children"><a href="#">Capacitaciones</a>
                                            <ul class="sub-menu">
                                                <li class="active"><a href="listarCertificaciones.php">Certificaciones</a></li>
                                                <li class="active"><a href="listarCursos.php">Cursos</a></li>
                                            </ul>
                                        </li>
                                        <!-- <li class="menu-item-has-children"><a href="#">Información</a>
                                            <ul class="sub-menu">
                                                <li><a href="about-us.html">Sobre nosotros</a></li>
                                                <li><a href="instructors.html">Nuestros instructores</a></li>
                                            </ul>
                                        </li> -->
                                    </ul>
                                </div>
                                    ...
                                    <form action="#" class="tgmenu__search-form">
                                        <div class="select-grp">
                                            ...
                                            <select class="form-select" id="course-cat" aria-label="Default select example" style="width: 150px">
                                                ...
                                                <option value="2">Tecnicatura</option>
                                                <option value="3">Auxiliar</option>
                                            </select>
                                        </div>
                                        <div class="input-grp">
                                            <input type="text" placeholder="Buscar por Cusos . . .">
                        ...
                        <div class="tgmobile__menu">
                            <nav class="tgmobile__menu-box">
                                ...
                                <div class="nav-logo">
                                    <a href="../home"><img src="../../public/img/logo_ape.jpg" alt="Logo"></a>
                                </div>
