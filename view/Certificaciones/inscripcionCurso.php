...
if (isset($_SESSION["usuario_id"])) {
    ...
    <body class="with-side-menu">
                        ...
                        <section class="box-typical proj-page">
                            ...
                            <section class="proj-page-section" id="seccion_explicativo">
                                ...
                                <div class="proj-page-txt">
                                    ...
                                    <p>
                                        Descargue de aquí el formulario de inscripción. Luego de imprimirlo, completarlo y
                                        escanearlo,
                            ...
                            if (isset($_GET['ID'])) {
                                if ($_SESSION['usuario_id'] != $info_solicitante['solicitante']) {
                                    ...
                                    <section class="proj-page-section" id="adjuntos_solicitante">
                                        <header class="proj-page-subtitle with-del">
                                            <div class="row">
                                                <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row" style="margin-left:25px;">
                                                ...
                                                $decifrado = openssl_decrypt($cifradoSinIV, $cipher, $key, OPENSSL_RAW_DATA, $iv_dec);
                                                $decifrado = openssl_decrypt($cifradoSinIV, $cipher, $key, OPENSSL_RAW_DATA, $iv_dec);
                                                $documentos = Certificacion::get_docs_x_tramite_gestionado($decifrado);
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="proj-page-attach">
                                                                <i class="font-icon font-icon-doc"></i>
                                                                <p class="name">
                                                                    <?php echo basename($value["documento"]) ?>
                                                                </p>
                                                                <p class="date">
                                                                    <?php echo $value["hora_formato_doc"] . ", " . $value["fecha_formato_doc"] ?>
                                                                </p>
                                                                <p>
                                                                    <a href="<?php echo '../' . $value["documento"] ?>"
                                                                        target="_blank">Ver</a>
                                                                    <!--<a href="
                                                            <?php
                                                            // echo '../' . $value["archivo"] 
                                                            ...
                                                            ">Descargar</a>-->
                                                                    <a style="color:#0082c6;"
                                                                        onclick="eliminarMaterialSeccion(<?php echo $value['documento_id'] ?>, '<?php echo $value['documento'] ?>')">Eliminar</a>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                        ...
                        <section class="box-typical proj-page">
                            <section class="proj-page-section" id="btn_solicitante">
                                <ul class="proj-page-actions-list">
                                    <li onclick="guardarInscripcion(11)" id="enviar_inscripcion_btn"><a><i
                            ...
                            <section class="proj-page-section" id="btn_administrativo">
                                <ul class="proj-page-actions-list">
                                    <li onclick="aprobarInscripcion(3)" id="aprobar_inscripcion_btn"><a><i
                                                class="font-icon font-icon-check-square"></i>Aprobar</a></li>
                                    <li onclick="rechazarInscripcion(6)" id="rechazar_inscripcion_btn"><a
                                            class="cancelar"><i class="font-icon font-icon-close"></i>Rechazar</a></li>
                                </ul>
                            </section><!--.proj-page-section-->
                            <section class="proj-page-section">
                                <ul class="proj-page-actions-list">
        ...
        <script type="text/javascript" src="../Movimientos/movimientos.js?v=<?php echo time(); ?>"></script>
