        ...
        <div id="preloader">
            <div id="loader" class="loader">
                <div class="loader-container">
                    <div class="loader-icon"><img src="../../assets/skillgro/img/logo/preloader.svg" alt="Preloader"></div>
                </div>
            </div>
        </div>
        <!--Preloader-end -->
                        ...
                        <div class="col-12">
                            <div class="breadcrumb__content">
                                ...
                                <nav class="breadcrumb">
                                    ...
                                    <a href="listarCursos.php"><span property="itemListElement"
                                            typeof="ListItem">Cursos</span></a>
                                </nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-4 order-2 order-lg-0">
                            <aside class="courses__sidebar">
                                <div class="courses-widget">
                                    ...
                                    $categorias = Certificacion::get_categorias_cursos($_SESSION['usuario_id']);
                                    ?>
                                ...
                                <!-- <div class="courses-widget">
                                    <h4 class="widget-title">Mis cursos</h4>
                                    <div class="courses-cat-list">
                                        <?php

                                        // $cursos_estados = Certificacion::get_mis_cursos_estados($_SESSION["usuario_id"]);
                                        ?>
                                        <ul class="list-wrap">
                                            <li>
                                                <div class="form-check">
                        ...
                        <div class="col-xl-9 col-lg-8">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <?php
                                if ($get_all) {
                                    $cursos = Certificacion::get_mi_aprendizaje_cursos($_SESSION["usuario_id"]);
                                }
                                ?>
