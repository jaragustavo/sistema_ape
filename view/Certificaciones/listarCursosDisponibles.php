			...
			<div class="container-fluid">
				...
				<div class="box-typical box-typical-padding">
					...
					<div class="row" style="margin-bottom:50px;">
						<div class="col-lg-6">
							<fieldset class="form-group">
								...
								<select class="select2" id="tramite_nuevo" name="tramite_nuevo"
						...
						<div class="col-lg-2">
							<fieldset class="form-group">
								...
								<button type="button" class="btn btn-rounded btn-success btn-block"
									onclick="abrirNuevoCurso()" id="btnnuevo">Nuevo Trámite</button>
							</fieldset>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-3">
							<fieldset class="form-group">
								...
								<select class="select2" id="estado_tramite" name="estado_tramite"
									data-placeholder="Seleccionar">
									<option label="Seleccionar"></option>
					...
					<div class="box-typical box-typical-padding" id="table">
						<table id="cursos_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
							<thead>
								<tr>
