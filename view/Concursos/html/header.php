                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul class="tg-header__top-info list-wrap">
                            ...
                            <li><img src="../../public/skillgro/img/icons/envelope.svg" alt="Icon"> <a href="mailto:info@sistema-ape.com">info@sistema-ape.com</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
                        <div class="tg-header__top-right">
                            <div class="tg-header__phone">
                                <img src="../../public/skillgro/img/icons/phone.svg" alt="Icon">Llámanos: <a href="tel:021 224 940">021 224 940</a>
                            </div>
                        </div>
                    </div>
                </div>
