...
<body class="with-side-menu">
	...
	<div class="page-content">
		...
		<input type="hidden" id="tipo_solicitud" name="tipo_solicitud" value="CONCURSO">

			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Inscripciones a Concursos</h3>
							<ol class="breadcrumb breadcrumb-simple">
							<li><a href="../home/index.php">Trámites en línea</a></li>
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="row" style="margin-bottom:50px;">
					<div class="col-lg-6">
						<fieldset class="form-group">
							<label class="form-label" for="tramite_nuevo">Solicitar inscripción</label>
					...
					<div class="col-lg-2">
						<fieldset class="form-group">
							...
							<button type="button" class="btn btn-rounded btn-success btn-block" onclick="abrirNuevoCurso()" id="btnnuevo">Nueva solicitud</button>
						</fieldset>
					</div>
				</div>	
				...
				<div class="box-typical box-typical-padding" id="table">
					<table id="concursos_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
						<thead>
							<tr>
								<th style="width: 5%;">Certificaciones</th>
