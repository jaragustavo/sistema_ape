            ...
            <div class="user-card-row">
                <div class="tbl-row">
                    <div class="tbl-cell tbl-cell-photo">
                        <a>
                        <?php
                         if (isset($value['foto_perfil']) && $value['foto_perfil'] !== "") {
                        ?>
                           <img src="<?php echo '../'.$value["foto_perfil"]?>" alt="">
                        <?php
                        } else {
                            ?>   
                    ...
                    <div class="tbl-cell">
                        <div class="user-card-row-name"><a href="../Publicaciones/perfilUsuario.php?ID=<?php echo $_SESSION["usuario_id"] ?>">
                    ...
                    <div class="comment-rows-container hover-action scrollable-block">
                        <div class="comment-row-item">
                            <div class="avatar-preview avatar-preview-32">
                                <a href="#">
                                    <!-- Foto comentario -->
                                    <img src="https://sirepro.mspbs.gov.py/foto/<?php echo $comentario["ci_usuario_comentario"] ?>.jpg"
                                        alt="">
                                </a>
                            </div>
