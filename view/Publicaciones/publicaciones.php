...
foreach ($publicaciones as $key => $value) {
    ...
    <article class="box-typical profile-post">
        <div class="profile-post-header">
            <div class="user-card-row">
                <div class="tbl-row">
                    <div class="tbl-cell tbl-cell-photo">
                        <a>
                        <?php
                         if (isset($value['publicante_foto_perfil']) && $value['publicante_foto_perfil'] !== "") {
                        ?>
                           <img src="<?php echo '../'.$value["publicante_foto_perfil"]?>" alt="">
                        <?php
                        } else {
                            ?>   
                            <img src="../../assets/assets-main/images/icons/user2.png" alt="">
                    ...
                    <div class="tbl-cell">
                        <div class="user-card-row-name"><a
                                href="../Publicaciones/perfilUsuario.php?ID=<?php echo $value["publicante_id"] ?>">
            ...
            <?php if ($_SESSION['usuario_id'] == $value['publicante_id']) {
                ?>
                <a class="shared" onclick="deletePublicacion(<?php echo $value['publicacion_id'] ?>)">
                ...
                <div class="col">
                    ...
                    if ($mime_type == "image/png" || $mime_type == "image/jpg" || $mime_type == "image/jpeg") {
                        ...
                        <a class="fancybox" rel="gall-1" href="<?php echo $value_doc["url_doc"] ?>">
                            <img src="<?php echo $value_doc["url_doc"] ?>" alt="" style="width: 200px; height: auto;">
                        </a>
                        <?php
                    } else {
                    ...
                    <div class="comment-rows-container hover-action scrollable-block">
                        <div class="comment-row-item">
                            <div class="avatar-preview avatar-preview-32">
                                <a href="#">
                                    <!-- Foto comentario -->
                                    <img src="../../assets/assets-main/images/icons/user2.png"
                                        alt="">
                                </a>
                            </div>
                            <div class="tbl comment-row-item-header">
                                <div class="tbl-row">
                                    ...
                                    <div class="tbl-cell tbl-cell-name">
                                        <?php echo $comentario["nombre_usuario_comentario"] ?>
                                    </div>
                                    <!-- fecha comentario -->
                            ...
                            <div class="comment-row-item-content">
                                <!-- Comentario -->
                                <p>
                                    <?php echo $comentario["texto_comentario"] ?>
                                </p>
                            </div>
        ...
        <input type="text" id="nuevo_comentario<?php echo $value['publicacion_id'] ?>" class="write-something"
