		...
		<div class="container-fluid">
			...
			<header class="section-header">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3>Solicitudes para la Sede Social</h3>
							<ol class="breadcrumb breadcrumb-simple">
							<li><a href="../home/index.php">Inicio</a></li>
								<li class="active">Solicitudes para la Sede Social</li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="row" style="margin-bottom:50px;">
					...
					<div class="col-lg-2">
						<fieldset class="form-group">
							...
							<button type="button" class="btn btn-rounded btn-success btn-block" onclick="abrirNuevaSolicitud()" id="btnnuevo">Nueva solicitud</button>
						</fieldset>
					</div>
				</div>	
				...
				<div class="box-typical box-typical-padding" id="table">
					<table id="reservas_data" class="table table-bordered table-striped table-vcenter js-dataTable-full">
						<thead>
							<tr>
								<th style="width: 5%;">Local</th>
								<th style="width: 5%;">Fecha de solicitud</th>
								<th style="width: 5%;">Fecha de la reserva</th>
								<th style="width: 5%;">Estado Actual</th>
