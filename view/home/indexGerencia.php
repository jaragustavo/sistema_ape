						...
						<div class="col-sm-4">
							<a href="indexCurriculumVirtual.php">
								<article class="statistic-box green">
									<div>
										<div class="number" id="cantidad_tramites"></div>
						...
						<a href="index.php">
							<div class="col-sm-4">
								<article class="statistic-box yellow">
									<div>
										<div class="number" id="cantidad_usuarios"></div>
						...
						<a href="index.php">
							<div class="col-sm-4">
								<article class="statistic-box red">
									<div>
										<div class="number" id="cantidad_publicaciones"></div>
										<div class="caption"><div>Cantidad de Publicaciones</div></div>
									</div>
								</article>
							</div>
  						</a>
